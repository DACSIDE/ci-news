...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Our First CodeIgniter 4 php app!</title>
...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to our First  CodeIgniter php Dev! <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>The small framework with powerful features. You know the vibes!</h2>
